...
# Parsing + Configuration Script – HKT-IAQ-109 - Rev. B

This **Parsing + Configuration** script is designed for the **HKT-IAQ-109** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – HKT-IAQ-109 Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **HKT-IAQ-109** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
